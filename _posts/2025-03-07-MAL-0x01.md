...
2. [**Security Onion**](https://securityonionsolutions.com/)
3. [**Tsurugi Linux**](https://tsurugi-linux.org/downloads.php)
...
2. [**Malwoverview**](https://github.com/alexandreborges/malwoverview)
3. [**Didier Stevens Suite**](https://github.com/DidierStevens/DidierStevensSuite)
